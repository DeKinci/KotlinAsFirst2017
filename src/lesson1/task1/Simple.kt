 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = 4.445 * .01 * (48 * sagenes + 48 / 3 * arshins + vershoks)
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial * pow((percent + 100) / 100.0, 3.0)
